...
public class TrieImpl<Value> implements Trie<Value> {
    ...
    public List<Value> getAllSorted(String key, Comparator<Value> comparator) {
        ...
        for(Object val : documents.documents) if(val instanceof Document) ((Document) val).setLastUseTime(System.nanoTime());
    ...
    public List<Value> getAllWithPrefixSorted(String prefix, Comparator<Value> comparator) {
        ...
        //update document times when searched for
        for(Object val : documents) if(val instanceof Document) ((Document) val).setLastUseTime(System.nanoTime());
        return documents;
    }
    ...
    public Set<Value> deleteAllWithPrefix(String prefix) {
        ...
        for(Value val : prefixList){
            ...
            if(val instanceof String) {
                ...
                for(String word : getStringArrayOfWords(((Document) val).getDocumentAsTxt())){
                    deleteAll(word);
                }
            }
        }
    ...
    private Value deleteValue(List documents, Object value, Value val){
        ...
        }else if(value instanceof DocumentImpl || val instanceof DocumentImpl) {
